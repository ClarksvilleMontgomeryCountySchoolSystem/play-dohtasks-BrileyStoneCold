...
def main():
    color1 = "gray"
    color2 = "pink"
    print(f"1) Roll ball using {color1}./n")
    ...
    if choice1 == "long body"
        ...
        print("2) Keep is as a ball. /n")
    print(f"3) Roll into smaller ball using {color1} for the head. /n")
    ...
    if choice2 == "long tail":
        ...
        print(f"5) Add a small bump using {color2} to the back./n")
    print(f"6) Add four small legs to the bottom using {color1}./n")
    print("7) Add two dats for eyes and a tiny nose./n")
